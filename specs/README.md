...
Flujo (inspirado en GitHub Spec Kit): **spec** (qué y por qué) → **plan** (cómo) → **tasks** (pasos verificables) → implementación → verificación con el arnés.

| ID | Spec | Estado |
|---|---|---|
| 001 | [Fundamentos: principios y virtudes](001-fundamentos/spec.md) | Implementada |
| 002 | [Caso del día](002-caso-del-dia/spec.md) | Implementada |
